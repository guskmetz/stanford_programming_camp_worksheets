...
Here, you will load in the data for your plot. We will use the `nycflights13` package to load in the data.
...
Here, use your favorite regression model to estimate the effect of weather on flight delays. Feel free to replace my model with your own.
